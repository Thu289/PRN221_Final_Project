...
namespace ManageBookStore.Pages.Admin
{
    public class AddSupplierModel : PageModel
    {
        ...
        public AddSupplierModel(Prn221ManageStoreContext context, IAccount account)
        {
            _context = context;
            _account = account;
        }
        ...
        public IActionResult OnPost()
        {
            ...
            {
                ViewData["Error"] = "This username/ email of this supplier has been in system!";
                return Page();
            ...
            _account.AddRole(account.Id, "supplier");
